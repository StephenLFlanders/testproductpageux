...
export const LandingBandSection = ({
  ...
  return (
    <section className="mt-12 w-full bg-primary-100 dark:bg-primary-100/70 flex items-center justify-center p-4 md:p-6 gap-6">
      <section
        className={cn(
          'ultrawide-container gap-6 items-center lg:flex lg:flex-row',
        )}
      >
        <p className="w-full lg:w-auto flex flex-col flex-shrink-0 max-w-lg xl:max-w-2xl text-black">
