...
const Header = () => {
  return (
    <header className="flex items-center justify-between py-10 flex-wrap w-full mb-20 lg:mb-32 pt-6 lg:pt-12 wide-container">
      <div>
        <Link href="/" aria-label={siteConfig.logoTitle}>
          <div className="flex items-center gap-3 justify-between">
            <Image
              ...
              height={48}
              width={200}
              className="group-hover:animate-wiggle !h-10 !w-auto"
            />
